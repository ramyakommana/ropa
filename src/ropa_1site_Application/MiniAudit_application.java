...
public class MiniAudit_application extends Ropa_pom {
	...
	public static String password;
	  ...
	  public void application()throws InterruptedException {
		  try{
			...
			//*add an user*/
			wd.findElement(By.linkText("User Management")).click();
			wd.findElement(By.linkText("Add User")).click();
		
			wd.findElement(By.id("cphMaster_txtEmail")).sendKeys(sh.getRow(1).getCell(2).getStringCellValue());
			wd.findElement(By.id("cphMaster_txtFirstName")).sendKeys(sh.getRow(1).getCell(3).getStringCellValue());
			wd.findElement(By.id("cphMaster_txtLastName")).sendKeys(sh.getRow(1).getCell(4).getStringCellValue());
			wd.findElement(By.id("cphMaster_txtPassword")).sendKeys(sh.getRow(1).getCell(1).getStringCellValue());
			wd.findElement(By.id("cphMaster_txtRetypePassword")).sendKeys(sh.getRow(1).getCell(1).getStringCellValue());
			wd.findElement(By.id("cphMaster_chkUserList_0")).click();
			...
			wd.findElement(By.id("cphMaster_rdbtnSelectSurvey_2")).click();//initial
			//1 consultative
			//2 mini audit
			Thread.sleep(900);
      ...
      /*Site Information*/
	    ...
	    wd.findElement(By.id("ulFiles")).sendKeys(sh.getRow(i).getCell(59).getStringCellValue());
       ...
       /*Which of the following best describes where this facility is located?*/
		...
		WebElement element= wd.findElement(By.id("cphMaster_cphApplication_tabMachine_ctl00_cntMachine0_uploadPage5New_ulFiles"));
		Thread.sleep(1500);
		element.sendKeys(sh.getRow(i).getCell(52).getStringCellValue());
		...
		WebElement e=wd.findElement(By.id("cphMaster_cphApplication_tabMachine_ctl00_cntMachine0_TLD_OSLD_upload_ulFiles"));
		
		e.sendKeys(sh.getRow(i).getCell(54).getStringCellValue());
		...
		Thread.sleep(1500);
		WebElement el=wd.findElement(By.id("cphMaster_cphApplication_tabMachine_ctl00_cntMachine0_QAphantom_upload_ulFiles"));
		
		el.sendKeys(sh.getRow(i).getCell(55).getStringCellValue());
		...
		wd.findElement(By.id("cphMaster_cphApplication_tabMachine_ctl00_cntMachine0_dosimetry_upload_ulFiles")).sendKeys(sh.getRow(i).getCell(55).getStringCellValue());
		...
		wd.findElement(By.id("cphMaster_cphApplication_tabMachine_ctl00_cntMachine0_physicsQA_upload_ulFiles")).sendKeys(sh.getRow(i).getCell(55).getStringCellValue());
...
for(int k=0;k<=1;k++)
{
	String tab="__tab_cphMaster_cphApplication_tabPhysician_Page4Tab_"+k;
		...
		WebElement elm= wd.findElement(By.id(cntRleaseForm));
		elm.sendKeys(sh.getRow(i).getCell(57).getStringCellValue());
...
for(int m=0;m<=1;m++)
	...
	String country="cphMaster_cphApplication_tabPhysician_Page4Tab_"+m+"_cntRleaseForm"+m+"_phyDdlCountry"; 
		...
		WebElement elt= wd.findElement(By.id(load));
		elt.sendKeys(sh.getRow(i).getCell(59).getStringCellValue());
		Thread.sleep(1500);
	  ...
	  Thread.sleep(500);
		...
		//Describing purpose of the survey. Include any particular issues the surveyors should review and any previously identified problems such as NRC/state citations, etc.
		wd.findElement(By.id("cphMaster_cphApplication_txtNatureOfRequest")).sendKeys("comment");
		jse.executeScript("window.scrollBy(0,300)", "");
		...
		//A written directive is documented for each procedure and includes :
		//Treatment site
		...
		jse.executeScript("window.scrollBy(0,200)", "");
		//if yes
		WebElement w= wd.findElement(By.id("cphMaster_cphApplication_ufFiles1_ulFiles"));
		
		w.sendKeys(sh.getRow(1).getCell(81).getStringCellValue());
		...
		//if yes
		jse.executeScript("window.scrollBy(0,200)", "");
		WebElement eb= wd.findElement(By.id("cphMaster_cphApplication_UploadFiles1_ulFiles"));
		Thread.sleep(1500);
		eb.sendKeys(sh.getRow(1).getCell(82).getStringCellValue());
		...
		//upload
		WebElement be= wd.findElement(By.id("cphMaster_cphApplication_updChart_ulFiles"));
		be.sendKeys(sh.getRow(1).getCell(83).getStringCellValue());
		...
		//upload
		WebElement m= wd.findElement(By.id("cphMaster_cphApplication_fuMDSignature"));
		m.sendKeys(sh.getRow(1).getCell(87).getStringCellValue());
	
		wd.findElement(By.id("cphMaster_cphApplication_btnMDSignature")).click();
	
		jse.executeScript("window.scrollBy(0,1500)", "");
		
		wd.findElement(By.id("cphMaster_cphApplication_txtMiniAuditExceutedDate")).click();//calendar
		Ropa_pom.calendar("calendar", String.valueOf(Math.round(sh.getRow(1).getCell(86).getNumericCellValue())));
	   ...
	   //Print Title of Practice Site President/CEO or Owner
		...
		//upload
		WebElement u= wd.findElement(By.id("cphMaster_cphApplication_fuCEOSignature"));
		u.sendKeys(sh.getRow(1).getCell(91).getStringCellValue());
		...
		wd.findElement(By.id("cphMaster_cphApplication_Miniaudit_pay_rb1_0")).click();
		jse.executeScript("window.scrollBy(0,1500)", "");
		wd.findElement(By.id("cphMaster_btnNext")).click();
		Thread.sleep(500);
